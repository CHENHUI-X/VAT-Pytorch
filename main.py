...
def get_args_parser():
    parser = argparse.ArgumentParser('A pytorch version implementation of VAT', add_help=False)
    ...
    parser.add_argument('--input_size', default=32, type=int,
                        help='image input size , default is 32 for CIFAR-10 dataset ')
    parser.add_argument('--layer_scale_init_value', default=1e-6, type=float,
                        help="Layer scale initial values")

    # EMA related parameters
    parser.add_argument('--model_ema', default=False)
    parser.add_argument('--model_ema_decay', type=float, default=0.9999, help='')
    parser.add_argument('--model_ema_force_cpu', default=False, help='')
    parser.add_argument('--model_ema_eval', default=False, help='Using ema to eval during training.')
    ...
    parser.add_argument('--resplit',  default=False,
    ...
    parser.add_argument('--imagenet_default_mean_and_std', default=True)
    parser.add_argument('--data_set', default='CIFAR10', choices=['CIFAR100','CIFAR10', 'IMNET', 'image_folder'],
    ...
    parser.add_argument('--dist_eval',default=True,
                        help='Enabling distributed evaluation')
    parser.add_argument('--disable_eval', default=False,
    ...
    parser.add_argument('--project', default='VAT', type=str,
                        help="The name of the W&B project where you're sending the new run.")
    parser.add_argument('--wandb_ckpt', default=False,
...
def main(args):
    ...
    if args.disable_eval:
        # DO Not Distribution evaluation
